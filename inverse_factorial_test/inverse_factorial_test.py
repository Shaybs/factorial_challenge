...
def test_inverse_factorial_7():
    assert inverse_factorial.inverse_factorial(1) == '1.0! or 0!'
...
def test_inverse_factorial_10():
    assert inverse_factorial.inverse_factorial(2) == '2.0!'
